...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! Thank you for loving me ❤️, "+input+ "!</h2>"+
        "<img class='gif' alt='gif' src='https://media.giphy.com/media/fHGl1MDMNkO6fOaFDF/giphy.gif'/></div><button style='top: 70%; left: 48%' onclick='redirectToPage()'>Continue</button><script src='scriptMain.js'></script>"
    gifMain.src = "https://media.giphy.com/media/fHGl1MDMNkO6fOaFDF/giphy.gif";

}

function redirectToPage() {
    window.location.href = 'keyHeart.html';
}
